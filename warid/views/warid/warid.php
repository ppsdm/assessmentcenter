...
$rating2 = $result['aspek']['inteligensi_umum'];
$rating3 = $result['aspek']['inteligensi_umum'];
$rating4 = $result['aspek']['inteligensi_umum'];
$rating5 = $result['aspek']['inteligensi_umum'];
$rating6 = $result['aspek']['inteligensi_umum'];
$rating7 = $result['aspek']['inteligensi_umum'];
$rating8 = $result['aspek']['inteligensi_umum'];
$rating9 = $result['aspek']['inteligensi_umum'];
$rating10 = $result['aspek']['inteligensi_umum'];
$rating11 = $result['aspek']['inteligensi_umum'];
...
<table cellspacing="0" cellpadding="1" class="first">
    <tr>
        ...
        <td  bgcolor="#48e90a" align="right" width="71%"><h3><B>$total_bobot</B></h3></td>
        <td  bgcolor="#48e90a" align="center" width="14%"><h3><B>Nilai Total</B></h3></td>
        <td  bgcolor="#48e90a" align="center" width="5%"><h3><B>$total_min</B></h3></td>
        <td  bgcolor="yellow" align="center" width="5%"><h3><B>$total_pribadi</B></h3></td>
        <td  bgcolor="#48e90a" align="center" width="5%"><h3><B>$total_max</B></h3></td>
    </tr>
